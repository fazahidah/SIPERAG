...
<div class="container right">
  ...
  <input name="alamatibu" type="text" class="form-control form-custom3" id="alamatibu" placeholder="masukkan alamat">
</div>
<br>
...
<div class="container right">
  ...
  <input name="alamatayah" type="text" class="form-control form-custom3" id="alamatayah" placeholder="masukkan alamat">
</div>
<br>
