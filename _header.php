                    ...
                    <ul class="navbar-nav ml-auto">
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle" href="#" id="dropdown-a"
                                data-toggle="dropdown" id="loginForm" method="post" action="service/apiservices.php">
                                <?=$_SESSION['username']?>
                            </a>
                            <div class="dropdown-menu" aria-labelledby="dropdown-a">
                                <a class="dropdown-item" href="service/apiservices.php?req=logout">Logout</a>
                                <button type="button" class="dropdown-item" data-toggle="modal" data-target="#exampleModal">Call Center</button>
                            </div>
                        </li>
                    </ul>
                </div>
