...
<div class="container right">
  ...
  <input name="agamasaksi1" type="date" class="form-control form-custom2" id="agamasaksi1">
</div>
<br>
...
<div class="container right">
  ...
  <input name="tempatsaksi1" type="date" class="form-control form-custom2" id="tempatsaksi1">
</div>
<br>
...
<br>
    ...
    <div class="container">
      ...
      <input name="pekerjaansaksi1" type="text" class="form-control form-custom" id="pekerjaansaksi1" placeholder="Masukkan nama lengkap">
    </div>
    <br>
...
<div class="container right">
  ...
  <input nama="alamatsaksi1" type="text" class="form-control form-custom3" id="alamatsaksi1" placeholder="masukkan alamat">
</div>
<br>
...
<div class="container right">
  ...
  <input name="agamasaksi2" type="date" class="form-control form-custom2" id="agamasaksi2">
</div>
<br>
...
<div class="container right">
  ...
  <input name="tempatsaksi2" type="date" class="form-control form-custom2" id="tempatsaksi2">
</div>
<br>
...
<br>
    ...
    <div class="container">
      ...
      <input name="pekerjaansaksi2" type="text" class="form-control form-custom" id="pekerjaansaksi2" placeholder="Masukkan nama lengkap">
    </div>
    <br>
...
<div class="container right">
  ...
  <input nama="alamatsaksi2" type="text" class="form-control form-custom3" id="alamatsaksi2" placeholder="masukkan alamat">
</div>
<br>
